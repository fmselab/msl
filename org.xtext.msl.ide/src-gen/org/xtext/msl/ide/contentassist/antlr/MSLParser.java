...
public class MSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getAbstractGroupAccess().getGroup_3_2(), "rule__AbstractGroup__Group_3_2__0");
			builder.put(grammarAccess.getAbstractGroupAccess().getGroup_3_2_2(), "rule__AbstractGroup__Group_3_2_2__0");
			...
			builder.put(grammarAccess.getAttValueAccess().getNameAttAssignment_0(), "rule__AttValue__NameAttAssignment_0");
			builder.put(grammarAccess.getAttValueAccess().getValAttAssignment_2(), "rule__AttValue__ValAttAssignment_2");
			...
			builder.put(grammarAccess.getAbstractGroupAccess().getAttValuesAssignment_3_2_1(), "rule__AbstractGroup__AttValuesAssignment_3_2_1");
			builder.put(grammarAccess.getAbstractGroupAccess().getAttValuesAssignment_3_2_2_1(), "rule__AbstractGroup__AttValuesAssignment_3_2_2_1");
