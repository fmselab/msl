...
@after {
	...
	(
		...
		(
			(
				lv_nameParam_1_0=RULE_INSTANCE_ID
				{
...
// Rule TimeUnitKind
ruleTimeUnitKind returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
