...
public class MSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AbstractGroupElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cAttValuesAssignment_3_2_1 = (Assignment)cGroup_3_2.eContents().get(1);
		private final RuleCall cAttValuesAttValueParserRuleCall_3_2_1_0 = (RuleCall)cAttValuesAssignment_3_2_1.eContents().get(0);
		...
		private final Assignment cAttValuesAssignment_3_2_2_1 = (Assignment)cGroup_3_2_2.eContents().get(1);
		private final RuleCall cAttValuesAttValueParserRuleCall_3_2_2_1_0 = (RuleCall)cAttValuesAssignment_3_2_2_1.eContents().get(0);
		...
		//AbstractGroup:
		//	'group' name=PATTERN_ID '{' ('managedSyS' manSys=[AbstractSystem|PATTERN_ID] ('[' attValues+=AttValue (','
		//	attValues+=AttValue)* ']')?)? ('managedGrp' manGrp+=GroupDef (',' manGrp+=GroupDef)*)?
		//	'components' components+=AbstractComponent (',' components+=AbstractComponent)*
		//	'}';
		@Override public ParserRule getRule() { return rule; }
		
		//'group' name=PATTERN_ID '{' ('managedSyS' manSys=[AbstractSystem|PATTERN_ID] ('[' attValues+=AttValue (','
		//attValues+=AttValue)* ']')?)? ('managedGrp' manGrp+=GroupDef (',' manGrp+=GroupDef)*)? 'components'
		...
		//('managedSyS' manSys=[AbstractSystem|PATTERN_ID] ('[' attValues+=AttValue (',' attValues+=AttValue)* ']')?)?
		...
		//attValues+=AttValue
		public Assignment getAttValuesAssignment_3_2_1() { return cAttValuesAssignment_3_2_1; }
		
		//AttValue
		public RuleCall getAttValuesAttValueParserRuleCall_3_2_1_0() { return cAttValuesAttValueParserRuleCall_3_2_1_0; }
		...
		//attValues+=AttValue
		public Assignment getAttValuesAssignment_3_2_2_1() { return cAttValuesAssignment_3_2_2_1; }
		
		//AttValue
		public RuleCall getAttValuesAttValueParserRuleCall_3_2_2_1_0() { return cAttValuesAttValueParserRuleCall_3_2_2_1_0; }
	...
	public class ConcreteGroupElements extends AbstractParserRuleElementFinder {
		...
		//('managedSyS' manSys=[ConcreteSystem|INSTANCE_ID])?
		public Group getGroup_4() { return cGroup_4; }
