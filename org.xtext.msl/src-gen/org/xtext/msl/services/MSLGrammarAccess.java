...
public class MSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class AbstractGroupElements extends AbstractParserRuleElementFinder {
		...
		//AbstractGroup:
		//	'group' name=PATTERN_ID '{' ('managedSyS' manSys=[AbstractSystem|PATTERN_ID])? ('managedGrp' manGrp+=GroupDef (','
		//	manGrp+=GroupDef)*)?
		...
		//'group' name=PATTERN_ID '{' ('managedSyS' manSys=[AbstractSystem|PATTERN_ID])? ('managedGrp' manGrp+=GroupDef (','
		//manGrp+=GroupDef)*)? 'components' components+=AbstractComponent (',' components+=AbstractComponent)* '}'
		public Group getGroup() { return cGroup; }
